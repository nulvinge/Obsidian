...
class WriteArray t1 t2 a where
    writeArray :: Array t1 (Exp Word32) a -> Program Grid (Array t2 (Exp Word32) a)

{-
instance (Scalar a) => WriteArray LArray BArray (Exp a) where
...
instance (Scalar a) => WriteArray LArray GArray (Exp a) where
